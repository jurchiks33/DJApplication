...
public:
    ...
    // Add this setter method to link the EqualizerComponent
    void setEqualizerComponent(EqualizerComponent* eqComponent);
...
private:
    ...
    // Use a pointer here to allow setting it later
    EqualizerComponent* equalizerComponent = nullptr;
